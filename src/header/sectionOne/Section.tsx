        ...
        <div className={c.border}>
            ...
            <div className={c.text}>
                ...
                <div className={c.profile}>
                    ...
                    <div className={c.soc}>
                        <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/denis-yarmoshko-9b9495244/"
                           title='linkedIn'>
                        ...
                        <a title="telegram" rel="noreferrer" target="_blank" href="https://t.me/bibur13">
                            <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px"
                                 height="50px">
                                <path fill="#C4C4C4"
